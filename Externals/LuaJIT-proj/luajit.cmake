...
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_PPC")
	...
	if ("${TARGET_TESTARCH}" MATCHES "LJ_LE${WHITESPACE}1")
...
if ("${TARGET_TESTARCH}" MATCHES "LJ_ARCH_BITS${WHITESPACE}64")
	string(APPEND DASM_FLAGS " -D P64")
endif()

if ("${TARGET_TESTARCH}" MATCHES "LJ_HASJIT${WHITESPACE}1")
	string(APPEND DASM_FLAGS " -D JIT")
endif()

if ("${TARGET_TESTARCH}" MATCHES "LJ_HASFFI${WHITESPACE}1")
	string(APPEND DASM_FLAGS " -D FFI")
endif()

if ("${TARGET_TESTARCH}" MATCHES "LJ_DUALNUM${WHITESPACE}1")
	string(APPEND DASM_FLAGS " -D DUALNUM")
endif()

if ("${TARGET_TESTARCH}" MATCHES "LJ_ARCH_HASFPU${WHITESPACE}1")
...
if ("${TARGET_TESTARCH}" MATCHES "LJ_ABI_SOFTFP${WHITESPACE}1")
...
if ("${TARGET_TESTARCH}" MATCHES "LJ_NO_UNWIND${WHITESPACE}1")
...
if (TARGET_LJARCH STREQUAL "x64")
	if (NOT "${TARGET_TESTARCH}" MATCHES "LJ_FR2${WHITESPACE}1")
		set(DASM_ARCH "x86")
	endif()
...
if (TARGET_LJARCH STREQUAL "ppc")
	if ("${TARGET_TESTARCH}" MATCHES "LJ_ARCH_SQRT${WHITESPACE}1")
		string(APPEND DASM_FLAGS " -D SQRT")
	endif()
	if ("${TARGET_TESTARCH}" MATCHES "LJ_ARCH_ROUND${WHITESPACE}1")
		string(APPEND DASM_FLAGS " -D ROUND")
	endif()
	if ("${TARGET_TESTARCH}" MATCHES "LJ_ARCH_PPC32ON64${WHITESPACE}1")
		string(APPEND DASM_FLAGS " -D GPR64")
	endif()
endif()

set(HOST_ACFLAGS "${CMAKE_C_FLAGS} ${CCOPTIONS} ${TARGET_ARCH}")
message ("HOST_ACFLAGS: ${HOST_ACFLAGS}")
...
if (NOT PROJECT_PLATFORM_E2K)
	...
	set(MINILUA_CMAKE_EXTRA)
	if (MSVC)
		list(APPEND MINILUA_CMAKE_EXTRA "-A ${CMAKE_GENERATOR_PLATFORM}")
  endif()
